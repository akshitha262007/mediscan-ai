...
(function () {
    ...
    const T = {
        ...
        en: {
            ...
            result_heatmap     : 'ELA Heatmap',
            result_tech        : 'Technical Details',
            result_scan_id     : 'Scan ID',
            result_hash        : 'SHA-256 Hash',
            result_file_size   : 'File Size',
            result_analysed_by : 'Analysed By',
            result_org         : 'Organisation',
            result_scanned     : 'Scanned',
            result_file_type   : 'File Type',
            result_risk_level  : 'Risk Level',
        ...
        hi: {
            ...
            result_download_pdf: 'PDF रिपोर्ट डाउनलोड करें',
            result_ai_sum      : 'AI चिकित्सा सारांश',
            result_findings    : 'फोरेंसिक निष्कर्ष',
            result_modules     : 'मॉड्यूल स्कोर',
            result_heatmap     : 'ELA हीटमैप',
            result_tech        : 'तकनीकी विवरण',
            result_scan_id     : 'स्कैन ID',
            result_hash        : 'SHA-256 हैश',
            result_file_size   : 'फ़ाइल आकार',
            result_analysed_by : 'विश्लेषक',
            result_org         : 'संस्था',
            result_scanned     : 'स्कैन किया',
            result_file_type   : 'फ़ाइल प्रकार',
            result_risk_level  : 'जोखिम स्तर',
        ...
        kn: {
            ...
            result_download_pdf: 'PDF ವರದಿ ಡೌನ್‌ಲೋಡ್',
            result_ai_sum      : 'AI ವೈದ್ಯಕೀಯ ಸಾರಾಂಶ',
            result_findings    : 'ಫೋರೆನ್ಸಿಕ್ ಫಲಿತಾಂಶ',
            result_modules     : 'ಮಾಡ್ಯೂಲ್ ಸ್ಕೋರ್‌ಗಳು',
            result_heatmap     : 'ELA ಶಾಖ ನಕ್ಷೆ',
            result_tech        : 'ತಾಂತ್ರಿಕ ವಿವರಗಳು',
            result_scan_id     : 'ಸ್ಕ್ಯಾನ್ ID',
            result_hash        : 'SHA-256 ಹ್ಯಾಶ್',
            result_file_size   : 'ಫೈಲ್ ಗಾತ್ರ',
            result_analysed_by : 'ವಿಶ್ಲೇಷಕ',
            result_org         : 'ಸಂಸ್ಥೆ',
            result_scanned     : 'ಸ್ಕ್ಯಾನ್ ಆಗಿದೆ',
            result_file_type   : 'ಫೈಲ್ ಪ್ರಕಾರ',
            result_risk_level  : 'ಅಪಾಯ ಮಟ್ಟ',
        ...
        te: {
            ...
            result_download_pdf: 'PDF నివేదిక డౌన్‌లోడ్',
            result_ai_sum      : 'AI వైద్య సారాంశం',
            result_findings    : 'ఫోరెన్సిక్ ఫలితాలు',
            result_modules     : 'మాడ్యూల్ స్కోర్లు',
            result_heatmap     : 'ELA హీట్‌మ్యాప్',
            result_tech        : 'సాంకేతిక వివరాలు',
            result_scan_id     : 'స్కాన్ ID',
            result_hash        : 'SHA-256 హాష్',
            result_file_size   : 'ఫైల్ పరిమాణం',
            result_analysed_by : 'విశ్లేషకుడు',
            result_org         : 'సంస్థ',
            result_scanned     : 'స్కాన్ చేయబడింది',
            result_file_type   : 'ఫైల్ రకం',
            result_risk_level  : 'ప్రమాద స్థాయి',
